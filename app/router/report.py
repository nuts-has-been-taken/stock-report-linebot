...
from app.controller.report import handle_major_investors_query
...
async def get_major_investors(date: str = Query(..., description="Date in YYYY-MM-DD format")):
    """
    ...
    """
    return await handle_major_investors_query(date)